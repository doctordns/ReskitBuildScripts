# Configure-SQL2016-1.ps1

# Performs initial configuration of SQL2016 in the reskit domain.
...
$conf2 = {
  $VerbosePreference = 'Continue'
  Write-Verbose ' Installing SQL 2016 - this will take a long time - circa 30 minutes'
